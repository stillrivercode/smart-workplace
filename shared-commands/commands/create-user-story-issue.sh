...
# Usage: ./shared-commands/commands/create-user-story-issue.sh --title "TITLE" [OPTIONS]
...
main() {
    ...
    if [[ -f "$spec_file" ]]; then
        ...
        log_info "   ./shared-commands/commands/create-spec-issue.sh --title "$title Architecture" --user-story-issue $issue_number"
    fi
