...
#
# Usage:
# ./shared-commands/commands/add-user-story-comment.sh --issue <ISSUE_NUMBER>
#
# Arguments:
...
Generates a user story and appends it as a comment to an existing GitHub issue.

Required Options:
  --issue ISSUE_NUMBER    The number of the issue to which the user story will be appended
