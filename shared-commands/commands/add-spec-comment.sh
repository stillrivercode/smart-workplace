...
#
# Usage:
# ./shared-commands/commands/add-spec-comment.sh --issue <ISSUE_NUMBER>
#
# Arguments:
...
main() {
    ...
    while [[ $# -gt 0 ]]; do
        case "$1" in
            ...
            --help|-h)
                cat << EOF
Usage: $0 --issue ISSUE_NUMBER

Generates a technical specification and appends it as a comment to an existing GitHub issue.

Required Options:
  --issue ISSUE_NUMBER    The number of the issue to which the spec will be appended
