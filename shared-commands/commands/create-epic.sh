...
main() {
    ...
    while [[ $# -gt 0 ]]; do
        case "$1" in
            ...
            --help|-h)
                cat << EOF
Usage: $0 --title "TITLE" --body "BODY"

Creates a new Epic issue in the GitHub repository.

Required Options:
  --title "TITLE"    The title of the epic issue
  --body "BODY"      The body of the epic issue

Options:
  --help, -h         Show this help message

Examples:
  $0 --title "User Authentication Epic" --body "Implement complete user authentication system"
EOF
                exit 0
                ;;
            *)
